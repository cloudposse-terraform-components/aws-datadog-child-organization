...
func (s *ComponentSuite) TestBasic() {
	const component = "datadog-child-organization/basic"
...
func (s *ComponentSuite) TestEnabledFlag() {
	const component = "datadog-child-organization/disabled"
	const stack = "default-test"
	const awsRegion = "us-east-2"
...
func (s *ComponentSuite) SetupSuite() {
	s.InitConfig()
	s.Config.ComponentDestDir = "components/terraform/datadog-child-organization"
