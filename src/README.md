...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_datadog_child_organization"></a> [datadog\_child\_organization](#module\_datadog\_child\_organization) | cloudposse/platform/datadog//modules/child_organization | 1.7.0 |
